...
export class SubscriptionsModule implements OnModuleDestroy {
    ...
    static forRoot(port: number = Number(process.env.SUBSCRIPTION_PORT)): DynamicModule {
    ...
    createSubscriptionServer(schema: any, options: ServerOptions = {}, socketOptions: WebSocket.ServerOption = {}) {
